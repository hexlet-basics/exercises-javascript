...
В этом курсе мы используем двойные кавычки — этого же стиля придерживается форматтер, которым проверяется код в практиках. Одинарные берём тогда, когда внутри строки есть двойные. Апостроф внутри двойных кавычек проблемы не создаёт:
