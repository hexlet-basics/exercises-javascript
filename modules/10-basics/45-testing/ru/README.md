...
Кроме упражнений на сайте, будет крайне полезно экспериментировать с кодом в [консоли браузера](https://developer.mozilla.org/en-US/docs/Tools/Browser_Console). В любой ситуации, когда вы недопоняли что-то или хотите попробовать разные варианты, смело открывайте консоль и вводите туда код.
