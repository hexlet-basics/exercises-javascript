...
_BEGIN_ и _END_ здесь — это обычные комментарии, которые никак не влияют на работу программы. Они показывают, куда писать код задания.
...
Увидев _BEGIN_ и _END_, пишите свой код между ними, остальное оставляйте без изменений.
